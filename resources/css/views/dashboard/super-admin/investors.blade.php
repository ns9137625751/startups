...
<div id="import-modal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:1000;align-items:center;justify-content:center;">
    <div style="background:#fff;border-radius:12px;padding:2rem;max-width:500px;width:90%;">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-bold" style="color:#0d1b2a;">Import Investor Profiles</h3>
        ...
        <form method="POST" action="{{ route('dashboard.super-admin.investors.import') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4 p-3 bg-blue-50 rounded-lg">
                ...
                <ul class="text-xs text-blue-700 space-y-1">
                    ...
                    <li>• Users will be created with email as fund_email</li>
                    <li>• Default password: "12345678" (users need OTP verification)</li>
                    <li>• Approval status set to approved by default</li>
                    <li>• Investment sectors should be comma-separated domain IDs or JSON array</li>
                </ul>
                <div class="mt-2">
                    <a href="{{ route('dashboard.super-admin.investors.template') }}" 
