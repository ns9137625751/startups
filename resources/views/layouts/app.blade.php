    ...
    <nav class="bg-white border-b sticky top-0 z-50" style="border-color:var(--border);">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
            ...
            <div class="hidden lg:flex items-center gap-3">
                <a href="/join" class="text-sm font-semibold px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors">Sign In</a>
                <a href="/join" class="btn-green text-sm font-semibold px-5 py-2 rounded-lg">Get Started Free</a>
            </div>
        ...
        <div id="mob" class="hidden lg:hidden border-t bg-white px-6 py-3 space-y-1" style="border-color:var(--border);">
            ...
            <div class="pt-2 border-t" style="border-color:var(--border);">
                <a href="/join" class="btn-green block text-center text-sm font-semibold px-5 py-2.5 rounded-lg mt-2">Get Started Free</a>
            </div>
        </div>
    </nav>
