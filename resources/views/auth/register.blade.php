...
<head>
    ...
    <style>
        ...
        .input-field:focus {
            border-color: #57BD68;
            box-shadow: 0 0 0 3px rgba(87, 189, 104, 0.12);
            background: #fff;
        }
...
<body class="min-h-screen flex" style="background:#F7F9FC;">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="panel hidden lg:flex lg:w-5/12 xl:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
            <div
                style="position:absolute;width:400px;height:400px;border-radius:50%;border:1px solid rgba(255,255,255,0.05);top:-100px;left:-100px;">
            </div>
            <div
                style="position:absolute;width:300px;height:300px;border-radius:50%;border:1px solid rgba(255,255,255,0.05);bottom:50px;right:-80px;">
            </div>
            ...
            <div class="relative z-10">
                <div class="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-full text-xs font-semibold"
                    style="background:rgba(87,189,104,0.2); color:#57BD68;">
                ...
                <p class="text-gray-400 text-sm leading-relaxed mb-8 max-w-sm">
                    Whether you're a founder, investor, mentor or government body — StartupEco has the right tools and
                    network for you.
                </p>

                <!-- Benefits -->
                <div class="space-y-3">
                    @foreach ([['Access 500+ verified investors', '#57BD68'], ['Apply to government grant programs', '#FF8C42'], ['Connect with 200+ expert mentors', '#57BD68'], ['Join 50+ incubator programs', '#1F3C88'], ['Real-time ecosystem updates', '#57BD68']] as [$benefit, $color])
                        <div class="flex items-center gap-3">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                                style="background:{{ $color }}20;">
                                <svg class="w-3 h-3" style="color:{{ $color }};" fill="none"
            ...
            <div class="relative z-10">
                    ...
                    <div class="flex -space-x-2">
                        @foreach (['RK', 'AS', 'PM', 'VG', 'NM'] as $i => $init)
                            <div class="w-8 h-8 rounded-full border-2 border-gray-800 flex items-center justify-center text-xs font-bold text-white"
                                style="background:{{ ['#57BD68', '#1F3C88', '#FF8C42', '#0d1b2a', '#57BD68'][$i] }};">
                                {{ $init }}</div>
                        @endforeach
                    </div>
                ...
                <div class="flex gap-1">
                    @for ($i = 0; $i < 5; $i++)
                        <svg class="w-4 h-4" style="color:#FF8C42;" fill="currentColor" viewBox="0 0 20 20">
                            <path
        ...
        <div class="flex-1 flex flex-col justify-center items-center px-6 py-10 bg-white overflow-y-auto">
            <div class="w-full max-w-md">
                ...
                <a href="/" class="flex items-center gap-2 mb-8 lg:hidden">
                    ...
                    <span class="text-lg font-bold" style="color:#1a1a2e;">Startup<span
                            style="color:#57BD68;">Eco</span></span>
                </a>

                <h2 class="text-2xl font-bold mb-1" style="color:#1a1a2e;">Create your free account</h2>
                <p class="text-gray-500 text-sm mb-7">Already have an account? <a href="/login" class="font-semibold"
                        style="color:#57BD68;">Sign in →</a></p>
                ...
                <form method="POST" action="/register" class="space-y-5" id="regForm">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div>
                            <label class="block text-xs font-semibold mb-1.5" style="color:#374151;">Email
                                Address</label>
                    ...
                    <!-- Role Selection -->
                    <div>
                        <label class="block text-xs font-semibold mb-2" style="color:#374151;">I am joining as
                            a...</label>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="pwd" required
                                placeholder="Min 8 chars, uppercase + number" class="input-field"
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label class="block text-xs font-semibold mb-1.5" style="color:#374151;">Confirm
                            Password</label>
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="pwd2" required
                                placeholder="Repeat your password" class="input-field" style="padding-right:44px;"
                                oninput="checkMatch()">
                    ...
                    <label class="flex items-start gap-2.5 cursor-pointer">
                        <input type="checkbox" required
                            class="mt-0.5 w-3.5 h-3.5 rounded accent-green-500 flex-shrink-0">
                        <span class="text-xs text-gray-500">
                            I agree to the <a href="#" class="underline hover:text-gray-700">Terms of
                                Service</a>
